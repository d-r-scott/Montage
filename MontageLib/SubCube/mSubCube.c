...
/*************************************************************************************/
/*                                                                                   */
/*  mSubCube has three major modes and two "convenience" modes (other parameters     */
/*  omitted for clarity):                                                            */
/*                                                                                   */
/*  mSubCube    [-d][-h hdu] in.fit out.fit racent    deccent   xsize     ysize      */
/*  mSubCube -g [-d][-h hdu] in.fit out.fit lcent     bcent     xsize     ysize      */
